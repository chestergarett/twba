"""
Laundry chart builders for TWBA Dashboard.
...
def _filter_laundry_items(df: pd.DataFrame) -> pd.DataFrame:
    """Filter dataframe to only include laundry-related items."""
    if df.empty:
        return df
    df = df.copy()
    mask = (
...
def build_laundry_time_avgqty_figure(
    ...
    """Laundry Products Purchase Time x Average Quantity chart."""
...
def build_laundry_day_avgqty_figure(
    items_df: pd.DataFrame,
    start_date: Optional[str],
    end_date: Optional[str],
    gender: Optional[List[str]],
    ...
    """Laundry Products Purchase Day x Average Quantity chart."""
    lau = _filter_laundry_items(filter_data(items_df, [start_date, end_date], gender, age, payment, month_year, weekday_weekend))
    if lau.empty:
        return go.Figure().add_annotation(text="No laundry data", showarrow=False, x=0.5, y=0.5, xref="paper", yref="paper")
...
def build_laundry_brands_figure(
    items_df: pd.DataFrame,
    start_date: Optional[str],
    end_date: Optional[str],
    gender: Optional[List[str]],
...
def build_laundry_brands_day_figure(
    items_df: pd.DataFrame,
    start_date: Optional[str],
    end_date: Optional[str],
    gender: Optional[List[str]],
...
def build_laundry_gender_pie_figure(
    items_df: pd.DataFrame,
    start_date: Optional[str],
    end_date: Optional[str],
    gender: Optional[List[str]],
    ...
    """Laundry Purchases by Gender pie chart."""
    lau = _filter_laundry_items(filter_data(items_df, [start_date, end_date], gender, age, payment, month_year, weekday_weekend))
    if lau.empty:
        return go.Figure().add_annotation(text="No laundry data", showarrow=False, x=0.5, y=0.5, xref="paper", yref="paper")
...
def build_laundry_age_pie_figure(
    items_df: pd.DataFrame,
    start_date: Optional[str],
    end_date: Optional[str],
    gender: Optional[List[str]],
    ...
    """Laundry Purchases by Age Group pie chart."""
    lau = _filter_laundry_items(filter_data(items_df, [start_date, end_date], gender, age, payment, month_year, weekday_weekend))
    if lau.empty:
        return go.Figure().add_annotation(text="No laundry data", showarrow=False, x=0.5, y=0.5, xref="paper", yref="paper")
...
def build_laundry_gender_brand_figure(
    items_df: pd.DataFrame,
    start_date: Optional[str],
    end_date: Optional[str],
    gender: Optional[List[str]],
    ...
    """Gender x Laundry Brands Purchased chart."""
    lau = _filter_laundry_items(filter_data(items_df, [start_date, end_date], gender, age, payment, month_year, weekday_weekend))
    if lau.empty:
        return go.Figure().add_annotation(text="No laundry data", showarrow=False, x=0.5, y=0.5, xref="paper", yref="paper")
...
def build_laundry_cluster_items_figure(
    items_df: pd.DataFrame,
    start_date: Optional[str],
    end_date: Optional[str],
    gender: Optional[List[str]],
    ...
    """Number of Items Purchased with Surf pie chart."""
...
def build_laundry_cluster_categories_figure(
    items_df: pd.DataFrame,
    start_date: Optional[str],
    end_date: Optional[str],
    gender: Optional[List[str]],
    ...
    """Categories Purchased with Surf chart."""
    items_filtered = filter_data(items_df, [start_date, end_date], gender, age, payment, month_year, weekday_weekend)
    anchor_txns = items_filtered[items_filtered["brandName"].str.contains("surf", case=False, na=False)]
    if anchor_txns.empty:
        return go.Figure().add_annotation(text="No Surf data", showarrow=False, x=0.5, y=0.5, xref="paper", yref="paper")
...
def build_laundry_cluster_brands_figure(
    items_df: pd.DataFrame,
    start_date: Optional[str],
    end_date: Optional[str],
    gender: Optional[List[str]],
    ...
    """Top Brands Purchased with Surf chart."""
    items_filtered = filter_data(items_df, [start_date, end_date], gender, age, payment, month_year, weekday_weekend)
    anchor_txns = items_filtered[items_filtered["brandName"].str.contains("surf", case=False, na=False)]
    if anchor_txns.empty:
        return go.Figure().add_annotation(text="No Surf data", showarrow=False, x=0.5, y=0.5, xref="paper", yref="paper")
